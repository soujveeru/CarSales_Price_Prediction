...
#Ancova post boxcox
m4<-aov(Yprime~kilometer+yearOfRegistration+vehicleType_n+gearbox_n+fuelType_n+brand_n+model+pcode, model1_ds_train)                            
summary(m4)
...
write.csv(x = ds_after_pred1, file = "r1.csv")
