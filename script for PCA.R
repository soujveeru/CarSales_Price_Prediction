...
pc_ds<-model1_ds_train[,c(-1,-6,-10,-11,-13)]
#View(cor(pc_ds))
...
fa.parallel(cor(pc_ds), n.obs= 185811, fa="pc", show.legend=FALSE, main="Scree plot with parallel analysis") 

#Principal Component Analysis

library(psych)
PC <- principal(cor(pc_ds), nfactors=5, rotate="none") 
PC


model1_ds_test$yearOfRegistration<-model1_ds_test$yearOfRegistration-mean(model1_ds_test$yearOfRegistration)
model1_ds_test$kilometer<-model1_ds_test$kilometer-mean(model1_ds_test$kilometer)
model1_ds_test$powerPS<-model1_ds_test$powerPS-mean(model1_ds_test$powerPS)
model1_ds_test$vehicleType_n<-model1_ds_test$vehicleType_n-mean(model1_ds_test$vehicleType_n)
model1_ds_test$brand_n<-model1_ds_test$brand_n-mean(model1_ds_test$brand_n)
model1_ds_test$fuelType_n<-model1_ds_test$fuelType_n-mean(model1_ds_test$fuelType_n)
model1_ds_test$pcode<-model1_ds_test$pcode-mean(model1_ds_test$pcode)



model1_ds_train$yearOfRegistration<-model1_ds_train$yearOfRegistration-mean(model1_ds_train$yearOfRegistration)
model1_ds_train$kilometer<-model1_ds_train$kilometer-mean(model1_ds_train$kilometer)
model1_ds_train$powerPS<-model1_ds_train$powerPS-mean(model1_ds_train$powerPS)
model1_ds_train$vehicleType_n<-model1_ds_train$vehicleType_n-mean(model1_ds_train$vehicleType_n)
model1_ds_train$brand_n<-model1_ds_train$brand_n-mean(model1_ds_train$brand_n)
model1_ds_train$fuelType_n<-model1_ds_train$fuelType_n-mean(model1_ds_train$fuelType_n)
model1_ds_train$pcode<-model1_ds_train$pcode-mean(model1_ds_train$pcode)
...
model1_ds_test$pc1=(0.31*model1_ds_test$vehicleType_n-0.49*model1_ds_test$yearOfRegistration+0.59*model1_ds_test$gearbox_n-0.43*model1_ds_test$powerPS-0.05*model1_ds_test$brand_n-0.08*model1_ds_test$kilometer+0.69*model1_ds_test$fuelType_n+0.04*model1_ds_test$pcode)
model1_ds_test$pc2=(0.26*model1_ds_test$vehicleType_n-0.45*model1_ds_test$yearOfRegistration-0.04*model1_ds_test$gearbox_n-0.02*model1_ds_test$powerPS+0.59*model1_ds_test$brand_n+0.79*model1_ds_test$kilometer-0.28*model1_ds_test$fuelType_n-0.10*model1_ds_test$pcode)
model1_ds_test$pc3=(0.63*model1_ds_test$vehicleType_n+0.59*model1_ds_test$yearOfRegistration+0.21*model1_ds_test$gearbox_n-0.24*model1_ds_test$powerPS+0.41*model1_ds_test$brand_n-0.24*model1_ds_test$kilometer-0.20*model1_ds_test$fuelType_n+0.12*model1_ds_test$pcode)
model1_ds_test$pc4=(0.03*model1_ds_test$vehicleType_n-0.09*model1_ds_test$yearOfRegistration+0.0*model1_ds_test$gearbox_n+0.47*model1_ds_test$powerPS+0.17*model1_ds_test$brand_n-0.01*model1_ds_test$kilometer+0.18*model1_ds_test$fuelType_n+0.85*model1_ds_test$pcode)
model1_ds_test$pc5=(0.38*model1_ds_test$vehicleType_n-0.08*model1_ds_test$yearOfRegistration-0.36*model1_ds_test$gearbox_n+0.50*model1_ds_test$powerPS+0.21*model1_ds_test$brand_n-0.24*model1_ds_test$kilometer+0.41*model1_ds_test$fuelType_n-0.43*model1_ds_test$pcode)


model1_ds_train$pc1=(0.31*model1_ds_train$vehicleType_n-0.49*model1_ds_train$yearOfRegistration+0.59*model1_ds_train$gearbox_n-0.43*model1_ds_train$powerPS-0.05*model1_ds_train$brand_n-0.08*model1_ds_train$kilometer+0.69*model1_ds_train$fuelType_n+0.04*model1_ds_train$pcode)
model1_ds_train$pc2=(0.26*model1_ds_train$vehicleType_n-0.45*model1_ds_train$yearOfRegistration-0.04*model1_ds_train$gearbox_n-0.02*model1_ds_train$powerPS+0.59*model1_ds_train$brand_n+0.79*model1_ds_train$kilometer-0.28*model1_ds_train$fuelType_n-0.10*model1_ds_train$pcode)
model1_ds_train$pc3=(0.63*model1_ds_train$vehicleType_n+0.59*model1_ds_train$yearOfRegistration+0.21*model1_ds_train$gearbox_n-0.24*model1_ds_train$powerPS+0.41*model1_ds_train$brand_n-0.24*model1_ds_train$kilometer-0.20*model1_ds_train$fuelType_n+0.12*model1_ds_train$pcode)
model1_ds_train$pc4=(0.03*model1_ds_train$vehicleType_n-0.09*model1_ds_train$yearOfRegistration+0.0*model1_ds_train$gearbox_n+0.47*model1_ds_train$powerPS+0.17*model1_ds_train$brand_n-0.01*model1_ds_train$kilometer+0.18*model1_ds_train$fuelType_n+0.85*model1_ds_train$pcode)
model1_ds_train$pc5=(0.38*model1_ds_train$vehicleType_n-0.08*model1_ds_train$yearOfRegistration-0.36*model1_ds_train$gearbox_n+0.50*model1_ds_train$powerPS+0.21*model1_ds_train$brand_n-0.24*model1_ds_train$kilometer+0.41*model1_ds_train$fuelType_n-0.43*model1_ds_train$pcode)





model_pca<-aov(price~pc1+pc2+pc3+pc4+pc5, model1_ds_train)                            
summary(model_pca)


pred1<-predict(model_pca,model1_ds_test)
plot(pred1)
plot(model1_ds_test$price,pred1)
price_predicted<-pred1
...
#Exporting TEst file to excel
write.csv(x = ds_after_pred1, file = "r2.csv")
